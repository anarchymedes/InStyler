...
The way that seems to have worked, as far as I can judge, to solve the occasional failures to record a video, is a bit of 'vibe coding' using ChatGPT co-pilot. The AI suggested the queueing of the frames and generated the code that I had never seen before, not in any sample by Apple or anything I could google up.

On the same note, the oriention handling post-iOS 16 leaves much to be desired: once again, I was reduced to using ChatGPT's help.
